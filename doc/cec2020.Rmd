...
cecb::get_resultTable(csa$basic, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$basic, 1:10, 10, caption = "PPMF")
...
```{r}
cecb::get_resultTable(csa$rot, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$rot, 1:10, 10, caption = "PPMF")
```
...
```{r}
cecb::get_resultTable(csa$shift, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$shift, 1:10, 10, caption = "PPMF")
...
```{r}
cecb::get_resultTable(csa$bias, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$bias, 1:10, 10, caption = "PPMF")
```
...
```{r}
cecb::get_resultTable(csa$bias_shift_rot, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$bias_shift_rot, 1:10, 10, caption = "PPMF")
```
...
```{r}
#cecb::get_resultTable(csa$shift_rot, 1:10, 10, caption = "CSA")
#cecb::get_resultTable(ppmf$shift_rot, 1:10, 10, caption = "PPMF")
```
...
```{r}
cecb::get_resultTable(csa$bias_shift, 1:10, 10, caption = "CSA")
cecb::get_resultTable(ppmf$bias_shift, 1:10, 10, caption = "PPMF")
```
...
```{r}
#cecb::get_resultTable(csa$bias_rot, 1:10, 10, caption = "CSA")
#cecb::get_resultTable(ppmf$bias_rot, 1:10, 10, caption = "PPMF")
```
