...
```{r}
cecb::get_resultTable(csa$bias_shift_rot, 1:10, 10, caption = "CSA (bias & shift & rot)")
cecb::get_resultTable(ppmf$bias_shift_rot, 1:10, 10, caption = "PPMF (bias & shift & rot)")
```
...
```{r}
#cecb::get_resultTable(csa$shift_rot, 1:10, 10, caption = "CSA (shift & rot)")
#cecb::get_resultTable(ppmf$shift_rot, 1:10, 10, caption = "PPMF (shift & rot)")
```
...
```{r}
cecb::get_resultTable(csa$bias_shift, 1:10, 10, caption = "CSA (bias & shift)")
cecb::get_resultTable(ppmf$bias_shift, 1:10, 10, caption = "PPMF (bias & shift)")
```
...
```{r}
#cecb::get_resultTable(csa$bias_rot, 1:10, 10, caption = "CSA (bias & rot)")
#cecb::get_resultTable(ppmf$bias_rot, 1:10, 10, caption = "PPMF (bias & rot)")
```
